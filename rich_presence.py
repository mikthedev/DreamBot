...
def presence_now_playing(
    *,
    ...
    if paused:
        ...
        # Listening to <full title> — music-native and keeps the whole name
        name = full
    ...
    return DiscordRichPresence(
        ...
        small_image_key=source_key if source_key in {"youtube", "soundcloud"} else "youtube",
